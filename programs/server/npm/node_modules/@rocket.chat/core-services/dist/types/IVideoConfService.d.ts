import type { IRoom, IStats, IUser, UiKit, VideoConference, VideoConferenceCapabilities, VideoConferenceCreateData, VideoConferenceInstructions } from '@rocket.chat/core-typings';
...
export interface IVideoConfService {
    ...
    start(caller: IUser['_id'], rid: string, options: {
        title?: string;
    ...
    list(roomId: IRoom['_id'], pagination?: {
        offset?: number;
        count?: number;
    ...
    validateAction(event: string, caller: IUser['_id'], params: {
