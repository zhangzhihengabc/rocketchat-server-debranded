import type { IPaginationOptions, IQueryOptions, IRecordsWithTotal, ITeam, ITeamMember, ITeamStats, TEAM_TYPE, IRoom, IUser, IRole } from '@rocket.chat/core-typings';
...
export interface ITeamService {
    ...
    members(uid: string, teamId: string, canSeeAll: boolean, options?: IPaginationOptions, queryOptions?: Filter<IUser>): Promise<IRecordsWithTotal<ITeamMemberInfo>>;
