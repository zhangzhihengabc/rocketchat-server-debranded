...
export interface IMessageService {
    ...
    saveSystemMessage<T = IMessage>(type: MessageTypesValues, rid: string, message: string, user: Pick<IUser, '_id' | 'username' | 'name'>, extraData?: Partial<T>): Promise<IMessage['_id']>;
    beforeSave(param: {
        message: IMessage;
        room: IRoom;
        user: IUser;
