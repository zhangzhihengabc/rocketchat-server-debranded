...
export interface IRoomService {
    ...
    addUserToRoom(roomId: string, user: Pick<IUser, '_id' | 'username'> | string, inviter?: Pick<IUser, '_id' | 'username'>, silenced?: boolean): Promise<boolean | undefined>;
    removeUserFromRoom(roomId: string, user: IUser, options?: {
        byUser: Pick<IUser, '_id' | 'username'>;
    }): Promise<void>;
    getValidRoomName(displayName: string, roomId?: string, options?: {
    ...
    saveRoomTopic(roomId: string, roomTopic: string | undefined, user: {
        username: string;
        _id: string;
    }, sendMessage?: boolean): Promise<void>;
