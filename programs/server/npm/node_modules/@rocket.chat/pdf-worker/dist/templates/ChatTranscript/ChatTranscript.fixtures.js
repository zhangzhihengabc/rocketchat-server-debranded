...
exports.validFile = { name: 'screenshot.png', buffer: Buffer.from([1, 2, 3]) };
exports.invalidFile = { name: 'audio.mp3', buffer: null };
            ...
            md: [
                {
                    ...
                    value: [
                        {
                            type: 'PLAIN_TEXT',
                            value: 'Ac aliquet odio mattis. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat ',
                        },
                        {
                            type: 'BOLD',
                            value: [
                    ...
                    md: [
                        {
                            ...
                            value: [
                                {
                                    type: 'PLAIN_TEXT',
                                    value: 'Consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
                                },
                            ],
                        },
                    ],
...
//# sourceMappingURL=ChatTranscript.fixtures.js.map