...
const forked_matrix_bot_sdk_1 = require("@rocket.chat/forked-matrix-bot-sdk");
const intent_1 = require("./intent");
const log = logging_1.default.get("EncryptedIntent");
/**
...
class EncryptedIntent extends intent_1.Intent {
    constructor(botSdkIntent, botClient, intentOpts, encryptionOpts) {
        ...
        // the existing one.
        this.encryptionHsClient = new forked_matrix_bot_sdk_1.MatrixClient(this.encryptionOpts.originalHomeserverUrl, this.botSdkIntent.underlyingClient.accessToken);
    ...
    async loginForEncryptedClient() {
        ...
        const res = await this.botSdkIntent.underlyingClient.doRequest("POST", "/_matrix/client/r0/login", undefined, {
    ...
    async getEncryptedSession() {
        ...
        if (session) {
            ...
            try {
                const tempClient = new forked_matrix_bot_sdk_1.MatrixClient(this.botSdkIntent.underlyingClient.homeserverUrl, session.accessToken);
