...
export const RegisterForm = ({ setLoginRoute }) => {
    ...
    const handleRegister = (_h) => __awaiter(void 0, void 0, void 0, function* () {
        var { password, passwordConfirmation: _ } = _h, formData = __rest(_h, ["password", "passwordConfirmation"]);
