...
export type Bold = {
    type: 'BOLD';
    value: Array<MarkupExcluding<Bold> | Link | Emoji | UserMention | ChannelMention>;
};
export type Italic = {
    type: 'ITALIC';
    value: Array<MarkupExcluding<Italic> | Link | Emoji | UserMention | ChannelMention>;
};
export type Strike = {
    type: 'STRIKE';
    value: Array<MarkupExcluding<Strike> | Link | Emoji | UserMention | ChannelMention>;
};
export type Plain = {
    type: 'PLAIN_TEXT';
    value: string;
