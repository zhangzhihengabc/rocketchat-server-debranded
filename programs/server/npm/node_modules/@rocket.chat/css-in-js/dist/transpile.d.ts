...
export declare const createTranspileMiddleware: (options?: MiddlewareOptions) => Middleware;
/**
 * Transpiles CSS Modules content to CSS rules.
 */
export declare const transpile: (selector: string, content: string, middleware?: Middleware) => string;
export {};
