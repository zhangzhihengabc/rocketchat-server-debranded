...
class MatrixClient extends events_1.EventEmitter {
    ...
    getWhoAmI() {
        return __awaiter(this, void 0, void 0, function* () {
            const whoami = yield this.doRequest("GET", "/_matrix/client/r0/account/whoami");
    ...
    start(filter = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.crypto) {
                ...
                yield this.crypto.prepare(this.lastJoinedRoomIds);
    ...
    processSync(raw, emitFn = null) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.crypto) {
                const inbox = [];
                if ((_a = raw['to_device']) === null || _a === void 0 ? void 0 : _a['events']) {
                ...
                const counts = (_b = raw['device_one_time_keys_count']) !== null && _b !== void 0 ? _b : {};
                const changed = (_d = (_c = raw['device_lists']) === null || _c === void 0 ? void 0 : _c['changed']) !== null && _d !== void 0 ? _d : [];
                const left = (_f = (_e = raw['device_lists']) === null || _e === void 0 ? void 0 : _e['left']) !== null && _f !== void 0 ? _f : [];
                yield this.crypto.updateSyncData(inbox, counts, unusedFallbacks, changed, left);
            }
            ...
            for (let roomId in joinedRooms) {
                ...
                for (let event of room['timeline']['events']) {
                    ...
                    if (event['type'] === 'm.room.encrypted' && (yield ((_g = this.crypto) === null || _g === void 0 ? void 0 : _g.isRoomEncrypted(roomId)))) {
                        yield emitFn("room.encrypted_event", roomId, event);
                        try {
                            event = (yield this.crypto.decryptRoomEvent(new EncryptedRoomEvent_1.EncryptedRoomEvent(event), roomId)).raw;
                            event = yield this.processEvent(event);
                            yield emitFn("room.decrypted_event", roomId, event);
                        }
                        catch (e) {
                            LogService_1.LogService.error("MatrixClientLite", `Decryption error on ${roomId} ${event['event_id']}`, e);
                            yield emitFn("room.failed_decryption", roomId, event, e);
                        }
                    }
    ...
    getEvent(roomId, eventId) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const event = yield this.getRawEvent(roomId, eventId);
            if (event['type'] === 'm.room.encrypted' && (yield ((_a = this.crypto) === null || _a === void 0 ? void 0 : _a.isRoomEncrypted(roomId)))) {
                return this.processEvent((yield this.crypto.decryptRoomEvent(new EncryptedRoomEvent_1.EncryptedRoomEvent(event), roomId)).raw);
            }
            return event;
        });
    }
    ...
    sendEvent(roomId, eventType, content) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            if (yield ((_a = this.crypto) === null || _a === void 0 ? void 0 : _a.isRoomEncrypted(roomId))) {
                content = yield this.crypto.encryptRoomEvent(roomId, eventType, content);
     ...
     * @returns {Promise<string>} resolves to the event ID that represents the event
     */
    sendRawEvent(roomId, eventType, content) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    uploadDeviceKeys(algorithms, keys) {
        return __awaiter(this, void 0, void 0, function* () {
            const obj = {
                user_id: yield this.getUserId(),
                device_id: this.crypto.clientDeviceId,
                algorithms: algorithms,
                keys: keys,
            };
            obj['signatures'] = yield this.crypto.sign(obj);
     ...
     */
    getUserDevices(userIds, federationTimeoutMs = 10000) {
        return __awaiter(this, void 0, void 0, function* () {
            const req = {};
     ...
     * 10 seconds.
     */
    claimOneTimeKeys(userDeviceMap, federationTimeoutMs = 10000) {
        return __awaiter(this, void 0, void 0, function* () {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MatrixClient.prototype, "uploadDeviceKeys", null);
__decorate([
    (0, decorators_1.timedMatrixClientFunctionCall)(),
    (0, decorators_2.requiresCrypto)(),
    __metadata("design:type", Function),
