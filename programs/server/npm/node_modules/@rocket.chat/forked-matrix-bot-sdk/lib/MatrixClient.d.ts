...
import { DeviceKeyAlgorithm, DeviceKeyLabel, EncryptionAlgorithm, FallbackKey, MultiUserDeviceListResponse, OTKAlgorithm, OTKClaimResponse, OTKCounts, OTKs, OwnUserDevice } from "./models/Crypto";
...
export declare class MatrixClient extends EventEmitter {
     ...
     */
    uploadDeviceKeys(algorithms: EncryptionAlgorithm[], keys: Record<DeviceKeyLabel<DeviceKeyAlgorithm, string>, string>): Promise<OTKCounts>;
    /**
