...
type TeamProps = TeamsRemoveRoomProps | TeamsConvertToChannelProps | TeamsUpdateMemberProps | TeamsAddMembersProps | TeamsRemoveMemberProps | TeamsDeleteProps | TeamsLeaveProps | TeamsUpdateProps;
export declare const isTeamPropsWithTeamName: <T extends TeamProps>(props: T) => props is T & {
    teamName: string;
};
export declare const isTeamPropsWithTeamId: <T extends TeamProps>(props: T) => props is T & {
    teamId: string;
};
export type TeamsEndpoints = {
    ...
    '/v1/teams.removeRoom': {
        POST: (params: TeamsRemoveRoomProps) => {
            room: IRoom;
        };
    };
    '/v1/teams.members': {
