...
export type CalendarEndpoints = {
    '/v1/calendar-events.create': {
        POST: (params: CalendarEventCreateProps) => {
            id: ICalendarEvent['_id'];
        };
    };
    '/v1/calendar-events.list': {
        GET: (params: CalendarEventListProps) => {
            data: ICalendarEvent[];
        };
    };
    '/v1/calendar-events.info': {
        GET: (params: CalendarEventInfoProps) => {
            event: ICalendarEvent;
        };
    };
    '/v1/calendar-events.import': {
        POST: (params: CalendarEventImportProps) => {
            id: ICalendarEvent['_id'];
        };
    };
