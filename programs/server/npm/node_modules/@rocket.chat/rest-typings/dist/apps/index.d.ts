...
import type { AppScreenshot, App, FeaturedAppsSection, ILogItem, AppRequestFilter, AppRequestsStats, PaginatedAppRequests, UiKit } from '@rocket.chat/core-typings';
export type AppsEndpoints = {
    ...
    '/apps/externalComponentEvent': {
        POST: (params: {
            ...
            event: 'IPostExternalComponentOpened' | 'IPostExternalComponentClosed';
        }) => {
            result: any;
        };
    };
