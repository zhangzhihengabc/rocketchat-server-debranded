...
export interface IActionManager {
    ...
    on(eventName: 'busy', listener: ({ busy }: {
        busy: boolean;
    }) => void): void;
    off(viewId: string, listener: (data: any) => any): void;
    off(eventName: 'busy', listener: ({ busy }: {
        busy: boolean;
    }) => void): void;
    notifyBusy(): void;
    notifyIdle(): void;
...
export declare const ActionManagerContext: import("react").Context<IActionManager | undefined>;
//# sourceMappingURL=ActionManagerContext.d.ts.map