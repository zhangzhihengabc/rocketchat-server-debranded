...
export declare const TopBarToolBox: ({ children, className, ...props }: TopBarToolBoxProps) => JSX.Element;
type TopBarSectionProps = {
    children?: React.ReactNode;
    className?: string;
};
export declare const TopBarSection: ({ className, children, ...props }: TopBarSectionProps) => JSX.Element;
export declare const TopBarAvatar: {
    size: 'x24';
};
export declare const TopBarActions: (props: Omit<{
...
export declare const TopBarTitle: (props: TopBarTitleProps) => JSX.Element;
declare const _default: (({ className, ...props }: TopBarProps) => JSX.Element) & {
    Section: ({ className, children, ...props }: TopBarSectionProps) => JSX.Element;
    ToolBox: ({ children, className, ...props }: TopBarToolBoxProps) => JSX.Element;
    Wrapper: ({ children }: TopBarWrapperProps) => JSX.Element;
    Avatar: {
        size: "x24";
    };
    Actions: (props: Omit<{
