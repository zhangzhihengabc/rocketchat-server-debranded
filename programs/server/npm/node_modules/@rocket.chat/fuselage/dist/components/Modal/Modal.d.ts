...
import Box from '../Box';
export declare const Modal: React.ForwardRefExoticComponent<Pick<{
    wrapperFunction?: ((props: Pick<ComponentProps<typeof Box>, 'elevation' | 'className' | 'children'>) => ReactNode) | undefined;
    wrapper?: ElementType<Pick<{
    ...
    } & Partial<import("../Box/stylingProps").StylingProps> & Omit<React.AllHTMLAttributes<HTMLElement>, "ref" | "is" | "className" | "size" | "elevation"> & Omit<React.SVGAttributes<SVGElement>, "elevation" | keyof React.AllHTMLAttributes<HTMLElement>> & React.RefAttributes<any>, "className" | "elevation" | "children">> | undefined;
} & {
    is?: ElementType | undefined;
    className?: string | (<T extends readonly unknown[]>(...args: T) => string) | (string | false | 0 | (<T extends readonly unknown[]>(...args: T) => string) | null | undefined)[] | undefined;
    animated?: boolean | undefined;
