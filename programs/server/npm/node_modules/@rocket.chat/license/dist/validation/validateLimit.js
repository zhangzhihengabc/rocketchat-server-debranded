...
exports.validateWarnLimit = exports.validateLimit = void 0;
/**
 ...
 */
function validateLimit(max, currentValue, behavior, extraCount = 0) {
    switch (behavior) {
 ...
 * - false if the limit is not reached
 */
function validateWarnLimit(max, currentValue, behavior, extraCount = 0) {
    switch (behavior) {
        case 'invalidate_license':
        case 'prevent_installation':
        case 'disable_modules':
...
exports.validateWarnLimit = validateWarnLimit;
//# sourceMappingURL=validateLimit.js.map