...
export default {
    ...
    args: {
        ...
        countryOptions: __spreadArray(__spreadArray([], Object.entries(countries).map(function (_a) {
...
export var _RequestTrialPage = function (args) { return (_jsx(RequestTrialPage, __assign({}, args))); };
