...
export var logSubmit = function (onSubmit) {
    return function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        action('submit').apply(void 0, args);
    ...
    return function () {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        action("fetch(".concat(endpoint, ")")).apply(void 0, args);
...
export var validateUsername = fetchMock('/username/validate', function (username) {
    if (username === 'admin') {
        return "Username \"".concat(username, "\" is not available");
    }
    return true;
});
export var validateEmail = fetchMock('/email/validate', function (email) {
...
export var organizationIndustryOptions = [
...
export var organizationSizeOptions = [
    ['0', '1-250 people'],
    ['1', '251-500 people'],
    ['2', '501-1000 people'],
    ['3', '1001-4000 people'],
...
export var countryOptions = __spreadArray(__spreadArray([], Object.entries(countries).map(function (_a) {
