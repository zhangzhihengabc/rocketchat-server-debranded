...
var ToastBarProvider = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(ToastBarContext_1.ToastBarContext.Provider, __assign({ value: contextValue }, { children: [children, (0, jsx_runtime_1.jsx)(ToastBarPortal_1.default, { children: Object.entries(toasts === null || toasts === void 0 ? void 0 : toasts.reduce(function (zones, toast) {
                    ...
                    return ((0, jsx_runtime_1.jsx)(ToastBarZone_1.default, __assign({ position: zone }, { children: toasts.map(function (toast) { return ((0, jsx_runtime_1.jsx)(ToastBarTimed_1.default, __assign({}, toast), toast.id)); }) }), zone));
                }) })] })));
};
