...
it('renders empty', () => {
    const { container } = render(_jsx(Markup, { tokens: [] }));
    expect(container).toBeEmptyDOMElement();
});
it('renders a big emoji block', () => {
    render(_jsx(MarkupInteractionContext.Provider, { value: {
            convertAsciiToEmoji: true,
            useEmoji: true,
        }, children: _jsx(Markup, { tokens: [
                {
                    type: 'BIG_EMOJI',
                    value: [
...
it('renders a code block', () => __awaiter(void 0, void 0, void 0, function* () {
    render(_jsx(Suspense, { fallback: null, children: _jsx(Markup, { tokens: [
                {
                    type: 'CODE',
    ...
    yield waitFor(() => expect(screen.getByRole('region')).toBeInTheDocument());
    expect(screen.getByRole('region')).toHaveTextContent('```const foo = bar;```');
}));
it('renders a code block with language', () => __awaiter(void 0, void 0, void 0, function* () {
    render(_jsx(Suspense, { fallback: null, children: _jsx(Markup, { tokens: [
                {
                    type: 'CODE',
                    value: [{ type: 'CODE_LINE', value: { type: 'PLAIN_TEXT', value: 'const foo = bar;' } }],
...
it('renders a Katex block', () => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const { container } = render(_jsx(Suspense, { fallback: null, children: _jsx(Markup, { tokens: [
                {
                    type: 'KATEX',
                    value: 'x^2 + y^2 = z^2',
                },
    ...
    yield waitFor(() => expect(container.querySelector('math')).toBeTruthy());
    (_a = container.querySelector('math')) === null || _a === void 0 ? void 0 : _a.remove();
...
//# sourceMappingURL=Markup.spec.js.map