...
export default {
    ...
    component: Markup,
    decorators: [
        (Story) => (_jsxs(Suspense, { fallback: null, children: [_jsx(MessageContainer, { children: _jsx(MessageBody, { children: _jsx(Box, { className: css `
								> blockquote {
									padding-inline: 8px;
									border-radius: 2px;
									border-width: 2px;
...
export const Example = ({ msg }) => {
    const parseOptions = { katex: { dollarSyntax: true, parenthesisSyntax: true }, colors: true, emoticons: true };
    return _jsx(Markup, { tokens: parse(msg, parseOptions) });
};
Example.args = {
    msg: outdent `
		:smile:😀:smile:
...
//# sourceMappingURL=Markup.stories.js.map