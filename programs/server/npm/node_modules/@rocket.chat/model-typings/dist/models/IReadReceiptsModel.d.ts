...
export interface IReadReceiptsModel extends IBaseModel<ReadReceipt> {
    ...
    removeByIdPinnedTimestampLimitAndUsers(roomId: string, ignorePinned: boolean, ignoreDiscussion: boolean, ts: Filter<IMessage>['ts'], users: IUser['_id'][], ignoreThreads: boolean): Promise<DeleteResult>;
