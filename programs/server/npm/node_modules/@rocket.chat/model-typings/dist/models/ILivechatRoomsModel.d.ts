import type { IMessage, IOmnichannelRoom, IOmnichannelRoomClosingInfo, ISetting, ILivechatVisitor, MACStats } from '@rocket.chat/core-typings';
...
export interface ILivechatRoomsModel extends IBaseModel<IOmnichannelRoom> {
    getQueueMetrics(params: {
        departmentId: any;
        agentId: any;
        includeOfflineAgents: any;
        options?: any;
    }): any;
    ...
    findAllRooms(params: Period & WithDepartment & WithOnlyCount & WithOptions & {
        answered: any;
    }): any;
    ...
    setEmailTranscriptRequestedByRoomId(rid: string, transcriptInfo: NonNullable<IOmnichannelRoom['transcriptRequest']>): Promise<UpdateResult>;
    ...
    } & Record<string, unknown>): Promise<UpdateResult | undefined>;
    findById(_id: string, fields?: FindOptions<IOmnichannelRoom>['projection']): FindCursor<IOmnichannelRoom>;
    findByIds(ids: string[], fields?: FindOptions<IOmnichannelRoom>['projection'], extraQuery?: Filter<IOmnichannelRoom>): FindCursor<IOmnichannelRoom>;
    findOneByIdAndVisitorToken(_id: string, visitorToken: string, fields?: FindOptions<IOmnichannelRoom>['projection']): Promise<IOmnichannelRoom | null>;
    findOneByVisitorTokenAndEmailThread(visitorToken: string, emailThread: string[], options?: FindOptions<IOmnichannelRoom>): Promise<IOmnichannelRoom | null>;
    findOneByVisitorTokenAndEmailThreadAndDepartment(visitorToken: string, emailThread: string[], departmentId?: string, options?: FindOptions<IOmnichannelRoom>): Promise<IOmnichannelRoom | null>;
    findOneOpenByVisitorTokenAndEmailThread(visitorToken: string, emailThread: string[], options: FindOptions<IOmnichannelRoom>): Promise<IOmnichannelRoom | null>;
    ...
    findOpenByVisitorToken(visitorToken: string, options?: FindOptions<IOmnichannelRoom>, extraQuery?: Filter<IOmnichannelRoom>): FindCursor<IOmnichannelRoom>;
    findOneOpenByVisitorToken(visitorToken: string, options?: FindOptions<IOmnichannelRoom>): Promise<IOmnichannelRoom | null>;
    findOneOpenByVisitorTokenAndDepartmentIdAndSource(visitorToken: string, departmentId: string, source?: string, options?: FindOptions<IOmnichannelRoom>): Promise<IOmnichannelRoom | null>;
    findOpenByVisitorTokenAndDepartmentId(visitorToken: string, departmentId: string, options?: FindOptions<IOmnichannelRoom>, extraQuery?: Filter<IOmnichannelRoom>): FindCursor<IOmnichannelRoom>;
    findByVisitorToken(visitorToken: string, extraQuery?: Filter<IOmnichannelRoom>): FindCursor<IOmnichannelRoom>;
    findByVisitorIdAndAgentId(visitorId?: string, agentId?: string, options?: FindOptions<IOmnichannelRoom>, extraQuery?: Filter<IOmnichannelRoom>): FindCursor<IOmnichannelRoom>;
    findOneOpenByRoomIdAndVisitorToken(roomId: string, visitorToken: string, options?: FindOptions<IOmnichannelRoom>): Promise<IOmnichannelRoom | null>;
    findClosedRooms(departmentIds?: string[], options?: FindOptions<IOmnichannelRoom>, extraQuery?: Filter<IOmnichannelRoom>): FindCursor<IOmnichannelRoom>;
    ...
    saveAnalyticsDataByRoomId(room: IOmnichannelRoom, message: IMessage, analyticsData?: Record<string, string | number | Date>): Promise<UpdateResult>;
    getTotalConversationsBetweenDate(t: 'l', date: {
        gte: Date;
        lt: Date;
    }, data?: {
        departmentId: string;
    }): Promise<number>;
    getAnalyticsMetricsBetweenDate(t: 'l', date: {
        gte: Date;
        lt: Date;
    }, data?: {
        departmentId: string;
    }, extraQuery?: Filter<IOmnichannelRoom>): FindCursor<Pick<IOmnichannelRoom, 'ts' | 'departmentId' | 'open' | 'servedBy' | 'metrics' | 'msgs'>>;
    getAnalyticsMetricsBetweenDateWithMessages(t: string, date: {
        gte: Date;
        lt: Date;
    }, data?: {
        departmentId: string;
    }, extraQuery?: Document, extraMatchers?: Document): AggregationCursor<Pick<IOmnichannelRoom, '_id' | 'ts' | 'departmentId' | 'open' | 'servedBy' | 'metrics' | 'msgs'>>;
    ...
    changeAgentByRoomId(roomId: string, newAgent: {
        agentId: string;
        username: string;
    ...
    changeVisitorByRoomId(roomId: string, visitor: {
        _id: string;
        username: string;
        token: string;
    }): Promise<UpdateResult>;
