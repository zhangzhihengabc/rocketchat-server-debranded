...
export interface ILivechatAgentActivityModel extends IBaseModel<ILivechatAgentActivity> {
    ...
    createOrUpdate(data: Partial<Pick<ILivechatAgentActivity, 'date' | 'agentId' | 'lastStartedAt'>>): Promise<ModifyResult<ILivechatAgentActivity> | undefined>;
    updateLastStoppedAt(params: Pick<ILivechatAgentActivity, 'date' | 'agentId' | 'lastStoppedAt' | 'availableTime'>): Promise<UpdateResult | Document>;
    updateServiceHistory(params: Pick<ILivechatAgentActivity, 'date' | 'agentId'> & {
        serviceHistory: IServiceHistory;
    }): Promise<UpdateResult | Document>;
    findOpenSessions(): FindCursor<ILivechatAgentActivity>;
    findAllAverageAvailableServiceTime(params: {
        date: Date;
        departmentId?: string;
    }): Promise<{
