...
export interface IBannersDismissModel extends IBaseModel<IBannerDismiss> {
    ...
    findByUserIdAndBannerId<P extends Document>(userId: string, bannerIds: string[], options: FindOptions<P extends IBannerDismiss ? IBannerDismiss : P>): FindCursor<P>;
    findByUserIdAndBannerId<P extends Document>(userId: string, bannerIds: string[], options?: undefined | FindOptions<IBannerDismiss> | FindOptions<P extends IBannerDismiss ? IBannerDismiss : P>): FindCursor<P> | FindCursor<IBannerDismiss>;
}
