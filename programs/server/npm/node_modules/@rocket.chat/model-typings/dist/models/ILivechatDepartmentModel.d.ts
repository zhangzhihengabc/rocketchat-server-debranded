...
export interface ILivechatDepartmentModel extends IBaseModel<ILivechatDepartment> {
    ...
    findByNameRegexWithExceptionsAndConditions(searchTerm: string, exceptions: string[], conditions: Filter<ILivechatDepartment>, options: FindOptions<ILivechatDepartment>): FindCursor<ILivechatDepartment>;
    ...
    findEnabledByListOfBusinessHourIdsAndDepartmentIds(businessHourIds: string[], departmentIds: string[], options: FindOptions<ILivechatDepartment>): FindCursor<ILivechatDepartment>;
    ...
    createOrUpdateDepartment(_id: string | null, data: {
        enabled: boolean;
        name: string;
        description?: string;
    ...
    findEnabledWithAgentsAndBusinessUnit(_: any, projection: FindOptions<ILivechatDepartment>['projection']): Promise<FindCursor<ILivechatDepartment>>;
