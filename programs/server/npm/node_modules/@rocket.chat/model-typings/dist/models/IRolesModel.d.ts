...
export interface IRolesModel extends IBaseModel<IRole> {
    ...
    findOneByIdOrName<P extends Document>(_idOrName: IRole['_id'] | IRole['name'], options: FindOptions<P extends IRole ? IRole : P>): Promise<P | null>;
    ...
    findInIdsOrNames<P>(_idsOrNames: IRole['_id'][] | IRole['name'][], options?: FindOptions<IRole>): P extends Pick<IRole, '_id'> ? FindCursor<P> : FindCursor<IRole>;
    ...
    updateById(_id: IRole['_id'], name: IRole['name'], scope: IRole['scope'], description?: IRole['description'], mandatory2fa?: IRole['mandatory2fa']): Promise<UpdateResult>;
    ...
    findUsersInRole<P extends Document>(roleId: IRole['_id'], scope: IRoom['_id'] | undefined, options: FindOptions<P extends IUser ? IUser : P>): Promise<FindCursor<P extends IUser ? IUser : P>>;
    /** @deprecated function getUsersInRole should be used instead */
    findUsersInRole<P>(roleId: IRole['_id'], scope: IRoom['_id'] | undefined, options?: any | undefined): Promise<FindCursor<IUser> | FindCursor<P>>;
    findCustomRoles(options?: FindOptions<IRole>): FindCursor<IRole>;
    createWithRandomId(name: IRole['name'], scope?: IRole['scope'], description?: string, protectedRole?: boolean, mandatory2fa?: boolean): Promise<InsertOneResult<WithId<IRole>>>;
