...
export interface ILivechatDepartmentAgentsModel extends IBaseModel<ILivechatDepartmentAgents> {
    ...
    findUsersInQueue<P extends Document>(usersList: string[], options: FindOptions<P extends ILivechatDepartmentAgents ? ILivechatDepartmentAgents : P>): FindCursor<P>;
    findUsersInQueue<P extends Document>(usersList: string[], options?: undefined | FindOptions<ILivechatDepartmentAgents> | FindOptions<P extends ILivechatDepartmentAgents ? ILivechatDepartmentAgents : P>): FindCursor<ILivechatDepartmentAgents> | FindCursor<P>;
    ...
    findAgentsByDepartmentId(departmentId: string, options: FindOptions<ILivechatDepartmentAgents>): FindPaginated<FindCursor<ILivechatDepartmentAgents>>;
    findAgentsByDepartmentId<P extends Document>(departmentId: string, options: FindOptions<P extends ILivechatDepartmentAgents ? ILivechatDepartmentAgents : P>): FindPaginated<FindCursor<P>>;
    findAgentsByDepartmentId(departmentId: string, options?: undefined | FindOptions<ILivechatDepartmentAgents>): FindPaginated<FindCursor<ILivechatDepartmentAgents>>;
    ...
    findActiveDepartmentsByAgentId<P extends Document>(agentId: string, options: FindOptions<P extends ILivechatDepartmentAgents ? ILivechatDepartmentAgents : P>): FindCursor<P>;
    findActiveDepartmentsByAgentId<P extends Document>(agentId: string, options?: undefined | FindOptions<ILivechatDepartmentAgents> | FindOptions<P extends ILivechatDepartmentAgents ? ILivechatDepartmentAgents : P>): FindCursor<ILivechatDepartmentAgents> | FindCursor<P>;
    ...
    findOneByAgentIdAndDepartmentId(agentId: string, departmentId: string, options?: FindOptions<ILivechatDepartmentAgents>): Promise<ILivechatDepartmentAgents | null>;
    ...
    getNextAgentForDepartment(departmentId: string, isLivechatEnabledWhenAgentIdle?: boolean, ignoreAgentId?: string, extraQuery?: Filter<IUser>): Promise<{
        agentId: string;
        username: string;
    } | null | undefined>;
    checkOnlineForDepartment(departmentId: string): Promise<boolean>;
    getOnlineForDepartment(departmentId: string, isLivechatEnabledWhenAgentIdle?: boolean): Promise<FindCursor<ILivechatDepartmentAgents> | undefined>;
    getBotsForDepartment(departmentId: string): Promise<undefined | FindCursor<ILivechatDepartmentAgents>>;
    getNextBotForDepartment(departmentId: string, ignoreAgentId?: string): Promise<{
        agentId: string;
        username: string;
    } | undefined>;
