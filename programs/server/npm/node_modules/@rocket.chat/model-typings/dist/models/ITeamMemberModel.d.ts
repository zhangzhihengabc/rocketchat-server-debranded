...
export interface ITeamMemberModel extends IBaseModel<ITeamMember> {
    ...
    findByUserId<P extends Document>(userId: string, options?: undefined | FindOptions<ITeamMember> | FindOptions<P extends ITeamMember ? ITeamMember : P>): FindCursor<P> | FindCursor<ITeamMember>;
    ...
    findOneByUserIdAndTeamId<P extends Document>(userId: string, teamId: string, options?: undefined | FindOptions<ITeamMember> | FindOptions<P extends ITeamMember ? ITeamMember : P>): Promise<P | null | ITeamMember>;
    ...
    findByTeamId<P extends Document>(teamId: string, options?: undefined | FindOptions<ITeamMember> | FindOptions<P extends ITeamMember ? ITeamMember : P>): FindCursor<P> | FindCursor<ITeamMember>;
    ...
    findByTeamIds<P extends Document>(teamIds: Array<string>, options?: undefined | FindOptions<ITeamMember> | FindOptions<P extends ITeamMember ? ITeamMember : P>): FindCursor<P> | FindCursor<ITeamMember>;
    ...
    findByTeamIdAndRole<P extends Document>(teamId: string, role: IRole['_id'], options?: undefined | FindOptions<ITeamMember> | FindOptions<P extends ITeamMember ? ITeamMember : P>): FindCursor<P> | FindCursor<ITeamMember>;
    ...
    createOneByTeamIdAndUserId(teamId: string, userId: string, createdBy: Pick<IUser, '_id' | 'username'>): Promise<InsertOneResult<ITeamMember>>;
