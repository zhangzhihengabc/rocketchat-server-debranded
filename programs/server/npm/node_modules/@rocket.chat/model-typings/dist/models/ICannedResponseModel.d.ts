...
export interface ICannedResponseModel extends IBaseModel<IOmnichannelCannedResponse> {
    ...
    createCannedResponse({ shortcut, text, tags, scope, userId, departmentId, createdBy, _createdAt, }: Omit<IOmnichannelCannedResponse, '_id' | '_updatedAt'>): Promise<Omit<IOmnichannelCannedResponse, '_updatedAt'>>;
    updateCannedResponse(_id: string, { shortcut, text, tags, scope, userId, departmentId, createdBy }: Omit<IOmnichannelCannedResponse, '_id' | '_updatedAt' | '_createdAt'>): Promise<Omit<IOmnichannelCannedResponse, '_updatedAt' | '_createdAt'>>;
