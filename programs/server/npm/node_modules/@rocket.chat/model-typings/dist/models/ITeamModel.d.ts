...
export interface ITeamModel extends IBaseModel<ITeam> {
    ...
    findByNames<P extends Document>(names: Array<string>, options?: undefined | FindOptions<ITeam> | FindOptions<P extends ITeam ? ITeam : P>): FindCursor<P> | FindCursor<ITeam>;
    ...
    findByIds<P extends Document>(ids: Array<string>, options: FindOptions<P extends ITeam ? ITeam : P>, query?: Filter<ITeam>): FindCursor<P>;
    findByIds<P extends Document>(ids: Array<string>, options?: undefined | FindOptions<ITeam> | FindOptions<P extends ITeam ? ITeam : P>, query?: Filter<ITeam>): FindCursor<P> | FindCursor<ITeam>;
    ...
    findByIdsAndType<P extends Document>(ids: Array<string>, type: TEAM_TYPE, options: FindOptions<P extends ITeam ? ITeam : P>): FindCursor<P>;
    findByIdsAndType<P extends Document>(ids: Array<string>, type: TEAM_TYPE, options?: undefined | FindOptions<ITeam> | FindOptions<P extends ITeam ? ITeam : P>): FindCursor<P> | FindCursor<ITeam>;
    ...
    findByType<P extends Document>(type: number, options?: undefined | FindOptions<ITeam> | FindOptions<P extends ITeam ? ITeam : P>): FindCursor<ITeam> | FindCursor<P>;
    ...
    findByNameAndTeamIds<P extends Document>(name: string | RegExp, teamIds: Array<string>, options: FindOptions<P extends ITeam ? ITeam : P>): FindCursor<P>;
    findByNameAndTeamIds<P extends Document>(name: string | RegExp, teamIds: Array<string>, options?: undefined | FindOptions<ITeam> | FindOptions<P extends ITeam ? ITeam : P>): FindCursor<P> | FindCursor<ITeam>;
    ...
    findOneByName<P extends Document>(name: string | RegExp, options?: undefined | FindOptions<ITeam> | FindOptions<P extends ITeam ? ITeam : P>): Promise<P | null> | Promise<ITeam | null>;
    ...
    findOneByMainRoomId<P extends Document>(roomId: string, options?: undefined | FindOptions<ITeam> | FindOptions<P extends ITeam ? ITeam : P>): Promise<P | null> | Promise<ITeam | null>;
    ...
    updateNameAndType(teamId: string, nameAndType: {
        name?: string;
        type?: TEAM_TYPE;
