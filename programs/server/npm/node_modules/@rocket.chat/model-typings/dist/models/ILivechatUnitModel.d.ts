...
export interface ILivechatUnitModel extends IBaseModel<IOmnichannelBusinessUnit> {
    findPaginatedUnits(query: Filter<IOmnichannelBusinessUnit>, options?: FindOptions<IOmnichannelBusinessUnit>): FindPaginated<FindCursor<IOmnichannelBusinessUnit>>;
    ...
    findOne(originalQuery: Filter<IOmnichannelBusinessUnit>, options: FindOptions<IOmnichannelBusinessUnit>): Promise<IOmnichannelBusinessUnit | null>;
    update(originalQuery: Filter<IOmnichannelBusinessUnit>, update: Filter<IOmnichannelBusinessUnit>, options: FindOptions<IOmnichannelBusinessUnit>): Promise<UpdateResult>;
    remove(query: Filter<IOmnichannelBusinessUnit>): Promise<DeleteResult>;
    createOrUpdateUnit(_id: string | null, { name, visibility }: {
        name: string;
        visibility: IOmnichannelBusinessUnit['visibility'];
    }, ancestors: string[], monitors: {
        monitorId: string;
        username: string;
    }[], departments: {
        departmentId: string;
