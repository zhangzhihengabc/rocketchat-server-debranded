...
export declare abstract class UiKitParserModal<OutputElement> extends SurfaceRenderer<OutputElement, ModalSurfaceLayoutBlock> {
    constructor();
}
export type ModalSurfaceLayout = ModalSurfaceLayoutBlock[];
export {};
//# sourceMappingURL=UiKitParserModal.d.ts.map