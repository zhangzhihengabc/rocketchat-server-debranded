...
export declare abstract class UiKitParserAttachment<T> extends SurfaceRenderer<T, AttachmentSurfaceLayoutBlock> {
    constructor();
}
export type AttachmentSurfaceLayout = AttachmentSurfaceLayoutBlock[];
export {};
//# sourceMappingURL=UiKitParserAttachment.d.ts.map