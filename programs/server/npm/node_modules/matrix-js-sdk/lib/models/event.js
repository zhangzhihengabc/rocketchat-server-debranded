...
class MatrixEvent extends _events.EventEmitter {
  ...
  get replyInThread() {
    var _this$getWireContent, _this$getWireContent$;

    const replyTo = (_this$getWireContent = this.getWireContent()) === null || _this$getWireContent === void 0 ? void 0 : (_this$getWireContent$ = _this$getWireContent["m.relates_to"]) === null || _this$getWireContent$ === void 0 ? void 0 : _this$getWireContent$["m.in_reply_to"];
    return this.replyEventId && replyTo[_event.UNSTABLE_ELEMENT_REPLY_IN_THREAD.name] || this.thread instanceof _thread.Thread;
  }
  /**
