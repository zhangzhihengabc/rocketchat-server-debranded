...
import { Box, Theme, CompleteTheme, Dimensions, ModernMotionProps, PropertyAccessor, ValueFormat } from '@nivo/core';
...
export declare type HeatMapSerie<Datum extends HeatMapDatum, ExtraProps extends object> = {
    id: string;
    data: Datum[];
} & ExtraProps;
...
export declare type LayerId = 'grid' | 'axes' | 'cells' | 'legends' | 'annotations';
...
export declare type CustomLayer<Datum extends HeatMapDatum> = FunctionComponent<CustomLayerProps<Datum>>;
export declare type CustomCanvasLayer<Datum extends HeatMapDatum> = (ctx: CanvasRenderingContext2D, props: CustomLayerProps<Datum>) => void;
export interface TooltipProps<Datum extends HeatMapDatum> {
    cell: ComputedCell<Datum>;
}
export declare type TooltipComponent<Datum extends HeatMapDatum> = FunctionComponent<TooltipProps<Datum>>;
...
export declare type CellComponent<Datum extends HeatMapDatum> = FunctionComponent<CellComponentProps<Datum>>;
...
export declare type CellCanvasRenderer<Datum extends HeatMapDatum> = (ctx: CanvasRenderingContext2D, props: CellCanvasRendererProps<Datum>) => void;
export declare type CellShape = 'rect' | 'circle';
export declare type HeatMapCommonProps<Datum extends HeatMapDatum> = {
...
export declare type HeatMapSvgProps<Datum extends HeatMapDatum, ExtraProps extends object> = Partial<HeatMapCommonProps<Datum>> & HeatMapDataProps<Datum, ExtraProps> & Dimensions & Partial<{
...
export declare type HeatMapCanvasProps<Datum extends HeatMapDatum, ExtraProps extends object> = Partial<HeatMapCommonProps<Datum>> & HeatMapDataProps<Datum, ExtraProps> & Dimensions & Partial<{
